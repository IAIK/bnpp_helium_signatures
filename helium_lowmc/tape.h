...
public:
  RandomTape(const std::vector<uint8_t> &seed, const salt_t &salt,
...
public:
  ...
  void generate_4_tapes(size_t repetition, size_t start_party,
                        const salt_t &salt, const gsl::span<uint8_t> &seed0,
                        const gsl::span<uint8_t> &seed1,
                        const gsl::span<uint8_t> &seed2,
                        const gsl::span<uint8_t> &seed3);
  void generate_tape(size_t repetition, size_t party, const salt_t &salt,
